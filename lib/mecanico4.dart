...
import 'mecanico5.dart';
import 'mecanico6.dart';
import 'mecanico7.dart';

class mecanico7 extends StatelessWidget {
...
class _MyStatefulWidgetState extends State<MyStatefulWidget> {
  ...
  cambio_paginadocumento(){
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => mecanico8()),
    );
  }
  ...
  cambio_paginacertificado(){
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => mecanico9()),
    );
  }
          ...
          return AlertDialog(
            ...
            child: RaisedButton(
              ...
              onPressed: ()=> Navigator.push(
                context,
                MaterialPageRoute(builder: (context) => mecanico10()),
              ),
